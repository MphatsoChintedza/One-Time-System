...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<a href="../admin/index.php" class="btn btn-primary" data-toggle="modal"><span class="glyphicon glyphicon-arrow"></span> Back To Notices</a>
            <?php 
                session_start();
						...
						try{	
						    ...
						    foreach ($db->query($sql) as $row) {
						    	...
						    	<tr>
						    		...
						    		<td>
						    			<a href="#edit_<?php echo $row['Id']; ?>" class="btn btn-success btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-edit"></span> Approve/Deny</a>
