    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel">Holiday Application Form </h4></center>
            </div>
			...
			<form method="POST" action="add.php">
				...
				<div class="row form-group">
				<!-- hidding form for pending inorder to send the pending into database by default -->
					<div class="col-sm-2">
						<label class="control-label" style="position:relative; top:7px;"></label>
					</div>
					<div class="col-sm-10">
						<input type="hidden" class="form-control" name="Holiday_status" value ="Pending" readonly> 
					</div>
				</div>
				<!-- hidding form for pending inorder to send the pending into database by default end here--> 
            </div> 
			</div>
